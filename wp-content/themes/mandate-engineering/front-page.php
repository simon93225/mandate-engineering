...
?>
    ...
    <section class="hero-section relative min-h-screen flex items-center pt-20 bg-brand-navy-deep text-white blueprint-grid">
        ...
        <div class="hero-content container mx-auto px-6 md:px-10 relative z-10 max-w-6xl">
            ...
            <h1 class="hero-title text-5xl sm:text-6xl md:text-8xl font-heading font-extrabold leading-none mb-8 tracking-tight">
                KEEP INDUSTRY <br/><span class="text-brand-emerald" style="text-shadow: 0 0 40px rgba(0, 230, 118, 0.25);">MOVING.</span>
            </h1>
            <p class="hero-copy text-lg md:text-2xl text-slate-300 mb-12 max-w-3xl leading-relaxed font-light">
                Manufacturing, servicing, and repair expertise for Harare, Bulawayo, and Zambia. Since 1998, we have supplied dependable products and solutions for air conditioning, cleaning, construction, transport, and home applications.
            </p>
